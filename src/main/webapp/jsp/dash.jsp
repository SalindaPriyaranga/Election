...
<head>
    ...
    <script src="/src/main/webapp/js/dashbord.js"></script>

    <script src="/src/main/webapp/js/jquery-1.11.1.min.js"></script>
...
<link href="/src/main/webapp/css/sidebar2.css" rel="stylesheet"/>
<body>
